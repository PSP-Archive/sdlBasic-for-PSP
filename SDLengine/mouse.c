...
//	int x,y;
	...
	mousex+=getaxisjoystick(0,0)/16000;
	return mousex;
}
//_______________________________________________________________________________________________________________________
...
int ymouse()
{
	...
	//SDL_GetMouseState(&x, &y);
	if (autotimer()!=0)return -1;
	mousey+=getaxisjoystick(0,1)/16000;
	return mousey;
}
//_______________________________________________________________________________________________________________________
...
int xmousescreen(int n)
{
	...
	//SDL_GetMouseState(&x, &y);
	if (autotimer()!=0)return -1;
	return xmouse()+SDLoffx[n]-SDLscreen_rect[n].x;
}
//_______________________________________________________________________________________________________________________
...
int ymousescreen(int n)
{
	...
	//SDL_GetMouseState(&x, &y);
	if (autotimer()!=0)return -1;
	return ymouse()+SDLoffy[n]-SDLscreen_rect[n].y;
}
//_______________________________________________________________________________________________________________________
...
{
	if (autotimer()!=0)return -1;
	if (getbuttonjoystick(0,2)==1) return 1;
	if (getbuttonjoystick(0,1)==1) return 2;
	if (getbuttonjoystick(0,3)==1) return 3;
	if (getbuttonjoystick(0,0)==1) return 4;
/*
